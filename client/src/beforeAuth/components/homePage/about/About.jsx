    ...
    <>
      ...
      <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-5 mx-auto">
        ...
        <div class="grid sm:grid-cols-2 sm:items-center gap-8">
          ...
          <div class="sm:order-2">
            <h2 class="text-center text-2xl font-bold md:text-3xl lg:text-4xl lg:leading-tight xl:text-5xl xl:leading-tight text-black dark:text-gray-200">
        ...
        <div class="grid sm:grid-cols-2 sm:items-center gap-8">
          ...
          <div class="sm:order-1">
            ...
            <div class="mt-10 text-center">
              <a
                class="bg-red-400 hover:bg-red-700 text-white font-bold py-2 px-4 rounded dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
            ...
            <div class="container mt-6 sm:mt-10 flex items-right">
              ...
              <div class="ms-3 sm:ms-4">
                <div className="icon flex">
                  ...
                  <a className="text text-black">(046)856-0656/865-0650</a>
                </div>
                <div className="icon flex">
                  <img src={Email} />
                  <a className="text-black" href="https://mail.google.com/mail/u/0/#inbox?compose=GTvVlcSKhbmGvwHKZhbhKNlLWKgdQNkCMkBlDHlmSlnvlNxTGNFXGnXMMhpbCbkdZMQCpmQFzzKdD">
                  mayorjun.naic@gmail.com
                  </a>
                </div>
                <div className="icon flex">
                  <img src={Facebook} />
                  <a className="text text-black" href="https://www.facebook.com/municipalityofnaic">
